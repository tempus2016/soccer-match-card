class SoccerMatchCard extends HTMLElement {
  ...
  render() {
    ...
    const homeTeamLogo = this.teamLogos[homeTeam] || '/local/images/team_logos/default.png';
    const awayTeamLogo = this.teamLogos[awayTeam] || '/local/images/team_logos/default.png';
